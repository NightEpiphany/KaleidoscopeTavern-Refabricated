...
public class AddFeaturesEvent {
    public static void addFeatures() {
        ServerLifecycleEvents.SERVER_STARTED.register(serverLevel -> {
            ...
            access.get(Registries.CONFIGURED_FEATURE).ifPresent(r -> {
                Registry<ConfiguredFeature<?, ?>> registry = r.value();
                ...
                addWildGrapevineTreeDeco(registry, TreeFeatures.OAK_BEES_0002_LEAF_LITTER, 0.002f, 3, 3);
                ...
                // 高大橡树会生成较多的葡萄藤
                addWildGrapevineTreeDeco(registry, TreeFeatures.FANCY_OAK_BEES_0002_LEAF_LITTER, 0.02f, 5, 7);
    ...
    private static void addWildGrapevineTreeDeco(
        ...
        ConfiguredFeature<?, ?> configuredFeature = registry.getValue(id);
