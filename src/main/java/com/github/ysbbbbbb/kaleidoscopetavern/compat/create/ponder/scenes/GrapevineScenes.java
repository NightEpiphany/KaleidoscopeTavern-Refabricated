...
public class GrapevineScenes {
    ...
    private static void growToMaxAge(SceneBuilder scene, BlockPos pos) {
        scene.idle(4);
        for (int i = 1; i < 4; i++) {
            int j = i;
