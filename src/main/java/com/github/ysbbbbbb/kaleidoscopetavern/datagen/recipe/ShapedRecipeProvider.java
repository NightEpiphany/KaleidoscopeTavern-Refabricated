...
public class ShapedRecipeProvider extends ModRecipeProvider {
    ...
    private void sofa(RecipeOutput consumer, Item item, Item wool) {
    ...
    private void barStool(RecipeOutput consumer, Item item, Item wool) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, item)
                .pattern("W")
                .pattern("C")
                .pattern("L")
    ...
    private void stringLights(RecipeOutput consumer, Item item, Item dye) {
