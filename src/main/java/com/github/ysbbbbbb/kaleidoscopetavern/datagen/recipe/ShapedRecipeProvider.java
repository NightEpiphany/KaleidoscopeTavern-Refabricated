...
import com.github.ysbbbbbb.kaleidoscopetavern.util.forge.Tags;
...
public class ShapedRecipeProvider extends ModRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        // 黑板
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.CHALKBOARD)
                .pattern("III")
                .pattern("ISI")
                .pattern("III")
        ...
        // 展板
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.BASE_SANDWICH_BOARD)
                .pattern("I")
                .pattern("S")
                .define('I', Items.INK_SAC)
        ...
        // 灯串
        // 无色的
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.STRING_LIGHTS_COLORLESS, 8)
                .pattern("CCC")
                .pattern("LLL")
        ...
        // 蒙德里安挂画是有序合成
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.MONDRIAN_PAINTING)
                .pattern(" B ")
                .pattern("WFY")
                .pattern(" R ")
        ...
        // 吧台
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.BAR_COUNTER)
                .pattern("NNN")
                .pattern("WWW")
                .pattern("WWW")
        ...
        // 人字梯
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.STEPLADDER)
                .pattern("L  ")
                .pattern("LL ")
                .pattern("LLL")
        ...
        // 藤架
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.TRELLIS, 16)
                .pattern("G")
                .pattern("G")
                .pattern("G")
                .define('G', ModItems.GRAPEVINE)
                .unlockedBy("has_grapevine", has(ModItems.GRAPEVINE))
                .save(consumer);

        // 龙头
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.TAP)
                .pattern("L")
                .pattern("H")
        ...
        // 酒桶
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.BARREL)
                .pattern("BBB")
                .pattern("BBB")
                .pattern("BBB")
        ...
        // 酒柜
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.BAR_CABINET)
                .pattern("GGG")
                .pattern("G G")
                .pattern("GGG")
                .define('G', ModItems.GRAPEVINE)
        ...
        // 玻璃酒柜
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.GLASS_BAR_CABINET)
                .pattern("GGG")
                .pattern("GPG")
                .pattern("GGG")
                .define('G', ModItems.GRAPEVINE)
    ...
    private void sofa(Consumer<FinishedRecipe> consumer, Item item, Item wool) {
    ...
    private void barStool(Consumer<FinishedRecipe> consumer, Item item, Item wool) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, item)
                .pattern("W")
                .pattern("C")
                .pattern("L")
    ...
    private void stringLights(Consumer<FinishedRecipe> consumer, Item item, Item dye) {
